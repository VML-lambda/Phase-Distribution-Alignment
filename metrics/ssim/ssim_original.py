...
def structural_similarity(im1, im2,
    ...
    if multichannel:
        ...
        if full:
            Lu = np.empty(im1.shape)
            Co = np.empty(im1.shape)
            St = np.empty(im1.shape)
            S = np.empty(im1.shape)
        for ch in range(nch):
            ch_result = structural_similarity(im1[..., ch],
                                              im2[..., ch], **args)
            if gradient and full:
                mssim[..., ch], G[..., ch], Lu[..., ch], Co[..., ch], St[..., ch], S[..., ch] = ch_result
            elif gradient:
                mssim[..., ch], G[..., ch] = ch_result
            elif full:
                mssim[..., ch], Lu[..., ch], Co[..., ch], St[..., ch], S[..., ch] = ch_result
            else:
                mssim[..., ch] = ch_result
        mssim = mssim.mean()
        if gradient and full:
